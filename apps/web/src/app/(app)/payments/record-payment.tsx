          ...
          {history.length > 0 && (
            <div className="mb-4 space-y-2">
              {history.map((p) => (
                <div
                  key={p.id}
                  className="flex flex-col gap-1.5 border-b border-slate-200 pb-2 text-sm last:border-b-0 last:pb-0 sm:flex-row sm:items-center sm:justify-between sm:gap-3"
                >
